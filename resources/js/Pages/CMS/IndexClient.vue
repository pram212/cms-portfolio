...
function submitDelete() {
    router.delete(route('clients.destroy', id.value), { preserveState: false })
}
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="flex justify-between">
            <Link :href="route('clients.create')" class="btn btn-sm btn-primary">Add</Link>
            <!-- PAGINATION -->
            <PaginationLink :links="clients.links"></PaginationLink>
        </div>
